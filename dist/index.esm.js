...
function CookieProvider({ children, config, }) {
    ...
    const updatePreferences = useCallback((prefs, method = "banner") => {
    ...
    if (!initialized)
        return null;
    return (jsx(CookieContext.Provider, { value: {
            preferences,
            hasConsent,
            updatePreferences,
            openPreferences,
...
export { CONSENT_STORAGE_KEY, CONSENT_VERSION, COOKIE_CATEGORIES, CookieProvider, DEFAULT_PREFERENCES, PREFERENCES_STORAGE_KEY, acceptAllPreferences, essentialOnlyPreferences, flushConsentQueue, logConsentEvent, profileRequiresBanner, registerPreferencesOpener, useAnalyticsConsent, useCookieConsent, useCookiePreferences };
